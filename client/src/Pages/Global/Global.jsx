    ...
    <section>
      <div className='logo-container'>
        <div className='logo'>
          ...
          <a className='btn-glo' onClick={() => setButtonPopup(true)}>Learn More</a>
        ...
        <div className='logo'>
          <img src={logo2} alt="tactica-costa-rica-logo" />
            ...
            <a className='btn-glo' onClick={() => setButtonPopup2(true)}>Learn More</a>
        ...
        <div className='logo'>
          <img src={logo3} alt="tactica-ecuador-logo" />
            ...
            <a className='btn-glo' onClick={() => setButtonPopup3(true)}>Learn More</a>
        ...
        <img src={logo4} alt="tactica-usa-logo" />
            <h2>TACTICA USA</h2>
            <a className='btn-glo' onClick={() => setButtonPopup4(true)}>Learn More</a>
        ...
        <div className='logo'>
          <img src={logo5} alt="tactica-sog-logo" />
            <h2>TACTICA SOG</h2>
            <a className='btn-glo' onClick={() => setButtonPopup5(true)}>Learn More</a>
            ...
            <Popup trigger={buttonPopup5} setTrigger={setButtonPopup5}>
              ...
              <p>Cindy and I hail from Michigan and have shared a remarkable journey together over our
              ...
              <p>My career has always been in public service. I served many years as a police officer
              ...
              <p>Ministries on our very first short-term mission trip to Costa Rica! We are beyond excited
              ...
              <p>It is our goal to provide missionaries with the necessary personal security training
        ...
        <div className='logo'>
          <img src={logo6} alt="tactica-jamaica-logo" />
            ...
            <a className='btn-glo' onClick={() => setButtonPopup6(true)}>Learn More</a>
        ...
        <div className='logo'>
          <img src={logo7} alt="tactica-panama-logo" />
            ...
            <a className='btn-glo' onClick={() => setButtonPopup7(true)}>Learn More</a>
