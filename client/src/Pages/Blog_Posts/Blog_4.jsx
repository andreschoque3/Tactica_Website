...
import BlogPic4_1 from './Images/blog-article-4-1.png'
import BlogPic4_2 from './Images/blog-article-4-2.png'
  ...
  return (
    <div className='Blog-post-3'>
        ...
        <div className='blog-container'>
            ...
            <img src={BlogPic4_2} alt="TACTICA Men’s Gathering: November 2023" />
            ...
            <img src={BlogPic4_1} alt="TACTICA Men’s Gathering: November 2023" className='second-pic-blog'/>
