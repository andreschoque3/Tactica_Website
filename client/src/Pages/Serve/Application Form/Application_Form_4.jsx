    ...
    <div>
      <Navbar/>
          <div className='form-container'>
                ...
                <form action="">
                  <div className='forms'>
                    ...
                    <div className='paragraph'>
                      ...
                      <textarea name="" id="" cols="60" rows="5" value={testimony} onChange={(e) => handleTextareaChange(e, setTestimony)} placeholder='Maximum of 300 words'></textarea>
                    </div>

                    <div className='paragraph'>
                      <label htmlFor="">Describe your understanding of the work of the Holy Spirit</label>
                      <textarea name="" id="" cols="60" rows="5" value={holyspirit} onChange={(e) => handleTextareaChange(e, setHolySpirit)} placeholder='Maximum of 300 words'></textarea>
                    </div>

                    <div className='paragraph'>
                      <label htmlFor="">Describe your current spiritual disciplines, strengths, and weaknesses (not your goal)</label>
                      <textarea name="" id="" cols="60" rows="5" value={spiritualworks} onChange={(e) => handleTextareaChange(e, setSpirtualWorks)} placeholder='Maximum of 300 words'></textarea>
                    </div>

                    <div className='paragraph'>
                      <label htmlFor="">Describe what is motivating you to apply for this mission trip</label>
                      <textarea name="" id="" cols="60" rows="5" value={motivation} onChange={(e) => handleTextareaChange(e, setMotivation)} placeholder='Maximum of 300 words'></textarea>
                    </div>

                    <div className='paragraph'>
                      <label htmlFor="">What do you believe are your 2-3 most dominant spiritual gifts?</label>
                      <textarea name="" id="" cols="60" rows="5" value={gifts} onChange={(e) => handleTextareaChange(e, setGifts)} placeholder='Maximum of 300 words'></textarea>
                    </div>
                    ...
                    <div className='text-radio'>
                      ...
                      <ul>
                        <li>
                          ...
                          <label htmlFor="">I enjoy public speaking, I love getting things done, I don't mind taking charge, and other would say that I am driven.</label>
                        </li>
                        <li>
                          <input type="radio" name="" id="" />
                          <label htmlFor="">Others seem to think I am entertaining. I like to cheer others up, I tend to think positively, and I prefer to be active.</label>
                        </li>
                        <li>
                          <input type="radio" name="" id="" />
                          <label htmlFor="">I prefer to serve quietly behind the scenes. Others would say that I am sensitive to people's needs and that I am a good listener. I don't mind not getting the credit.</label>
                        </li>
                        <li>
                          <input type="radio" name="" id="" />
                          <label htmlFor="">I enjoy organizing and administrative tasks; I thrive in order. I want things to be completed well and on time.</label>
                        </li>
                      </ul>
                    </div>
              ...
              <div className='details-block'>
                ...
                <form action="">
                  <div className='forms'>
                    <div className='field'>
                      <label htmlFor="">Signature</label>
                      <input type="text" id='' placeholder='Enter full name' />
                    </div>
              ...
              <Link className='form-btn-3' to='/Application-Form-3'>Back</Link>
              <Link className='form-btn-2' to='/Application-Form-'>Next</Link>
          </div>
      <Footer/>
    </div>
  )
