    ...
    <section className='blog-posts'>
        ...
        <div className='blog-post'>
          <div className='blog' id='1'>
            <img src={artPic1} alt="Burdened for those Silently Suffering in the Public Safety Community" />
              <h3>Daily Prayer</h3>
          ...
          <div className='blog' id='2'>
            <img src={artPic2} alt="a glance into the work of the ecuadorian special operations group" />
              <h3>Ministry Work</h3>
          ...
          {showExtraBlogs && (
            <>
              ...
              <div className='blog' id='8'>
                <img src={artPic8} alt="Baptist church honors law enforcement" />
                  <h3>Daily News</h3>
